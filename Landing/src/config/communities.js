...
export const UAE_COMMUNITIES = [
  {
    ...
    blurb: 'Downtown Dubai remains the UAE’s most recognised address — walkable luxury, hospitality-driven rental demand, and continuous off-plan launches from tier-one developers.',
    searchTerms: ['downtown', 'burj khalifa', 'downtown dubai'],
  ...
  },
  {
    ...
    blurb: 'The Palm offers scarcity value — branded beachfront residences and villa stock with strong prestige appeal for HNW buyers.',
    searchTerms: ['palm', 'palm jumeirah'],
  ...
  },
  {
    ...
    blurb: 'Dubai Hills Estate combines parkland, schools, and golf within a single Emaar masterplan — popular with families and long-term holders.',
    searchTerms: ['dubai hills', 'hills estate'],
  ...
  },
  {
    ...
    blurb: 'Business Bay sits at the heart of new Dubai — competitive entry prices, canal views, and steady off-plan supply for yield-focused investors.',
    searchTerms: ['business bay'],
  ...
  },
  {
    ...
    blurb: 'JVC delivers community living at accessible price points with consistent rental demand from young professionals and small families.',
    searchTerms: ['jvc', 'jumeirah village'],

    ...
    <section class="relative table w-full py-32 lg:py-36 bg-[url('../../assets/images/bg/01.jpg')] bg-no-repeat bg-center bg-cover">
        ...
        <div class="container relative">
            <div class="grid grid-cols-1 text-center mt-10">
                <h3 class="md:text-4xl text-3xl md:leading-normal leading-normal font-medium text-white">Off-Plan Projects — UAE</h3>
            </div>
        </div>
    </section>
    <div class="relative">
    ...
    <section class="relative lg:py-24 py-16">
        <div class="container">
            <ListingGridSkeleton
                v-if="reellyLoading"
                :count="6"
                grid-class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-7.5 mb-6"
            />
            <Pagination v-else :itemsPerPage="6" :items="saleListings" gridClass="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-7.5" />
            <h4 class="text-xl font-semibold mt-16 mb-6">Properties for rent</h4>
            <Pagination :itemsPerPage="6" :items="rentListings" gridClass="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-7.5" />
        </div>
    </section>
    <Footer />
    <Switcher />
...
const { saleListings, rentListings, loading: reellyLoading, loadProjects } = useReelly()
